            ...
            <div class="row g-5">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-footer-wrapper contact-wrap">
                        <h5 class="ft-title" id="ft-title-contact">Contact</h5>
                        <ul class="ft-link tmp-scroll-trigger animation-order-1 tmp-link-animation">
                            <li><span class="ft-icon"><i class="fa-solid fa-phone"></i></span><a href="#">+8801672245447</a></li>
                            <li><span class="ft-icon"><i class="fa-solid fa-location-dot"></i></span>Lalbag, Dhaka</li>
                            <li><span class="ft-icon"><i class="fa-solid fa-envelope"></i></span><a href="#">yusuf.bdmail@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
